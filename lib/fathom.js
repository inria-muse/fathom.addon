...
var extdevmode = (system.staticArgs && system.staticArgs.dev) || self.version.indexOf('-dev')>0 || self.version.indexOf('-beta')>0;
...
console.info("loading " + self.name + " addon v=" + self.version + " devmode=" + extdevmode);
		...
		if (req.module === 'internal') {
		    ...
		    case 'setup':
		    	return sendresp(req, {
		    		...
		    		enableapi : userPrefs[consts.FATHOMAPI]
		    	}, true);
