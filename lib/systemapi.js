        ...
        subprocess.call({
            ...
            arguments: [cmd],
                ...
                if (res.stdout && res.exitCode === 0) {
                    ...
                    console.log('systemapi','path '+cmd+'->'+tmp);
                    callback(tmp);          
                }
            },
            mergeStderr: false
...
api.getRoutingTable = function(callback, params, inc) {
    ...
    execcmd(function(resroutes, done) {
        ...
        if (os === darwin) {
            ...
            // fallback to selecting one of the possible default routes 
            resroutes.result.defaultgateway = _.find(resroutes.routes, function(r) { return r.defaultroute; });
            return _cb(resroutes, true);
        }
