...
var getnetworkenv = exports.getnetworkenv = function(callback) {
    ...
    // if was checked less than x sec ago, just return the old (avoid some overhead)
    if (current_env && ((ts.getTime() - current_env.ts) < config.BASELINE_ENV_TTL*1000)) {
...
var handlepageload = exports.handlepageload = function(p) {
    ...
    if (!match) {
        ...
        p.location.anonymized = true;
               ...
               canUpload(consts.PAGELOAD_UPLOAD)) {
