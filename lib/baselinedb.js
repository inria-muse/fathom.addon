...
DB.prototype.connect = function(cb) {
	...
	function onConnection(connection) {
		...
		if (!initdone) {
		    ...
		    ss.storage['baseline_dbupdate2'] = true;
		...
		} else if (!ss.storage['baseline_dbupdate2']) {
		    ss.storage['baseline_dbupdate2'] = true;
			...
			'ALTER TABLE agg3 ADD COLUMN wifi_quality real;');
                    ...
                    console.log('baselinedb tables updated 2');
		}
