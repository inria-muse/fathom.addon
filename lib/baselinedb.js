...
DB.prototype.connect = function(cb) {
	...
	function onConnection(connection) {
		...
		if (!initdone) {
		    ...
		    ss.storage['baseline_dbupdate'] = true;
                    console.log('baselinedb tables created');

		} else if (!ss.storage['baseline_dbupdate']) {
		    ss.storage['baseline_dbupdate'] = true;
			...
			'ALTER TABLE agg3 ADD COLUMN pageload_firstbyte_delay real;');
                    ...
                    console.log('baselinedb tables updated');
		}
...
DB.prototype.saveBaseline = function(bs) {
	...
	rtt3 : null,
	rttx : null,
	pageload_total : bs.pageload.total, 
	pageload_dns : bs.pageload.dns, 
	pageload_firstbyte : bs.pageload.firstbyte, 
	pageload_total_delay : bs.pageload.total_delay, 
	pageload_dns_delay : bs.pageload.dns_delay, 
	pageload_firstbyte_delay : bs.pageload.firstbyte_delay
    };
