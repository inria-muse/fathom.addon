...
var getenvfull = exports.getenvfull = function(callback, ts, localenv) {
    ...
    var f = function(env) {
        ...
        utils.lookupIP(function(ip) {
            ...
            utils.getMlabServer(function(sres) {
...
var getnetworkenv = exports.getnetworkenv = function(callback) {
    ...
    if (!current_env) {
        // 1) if no current_env do full lookup
        ...
        getenvfull(function(env) {
            ...
            return callback(current_env);
                ...
                ((ts.getTime() - current_env.ts) <= cfg[LOCAL_LOOKUP_TTL_SEC]*1000) ) 
    {
        // 2) if in activity burst or current_env is recent, return current_env
        ...
        // 3) local info is stale, resolve again
        ...
        getenvlocal(function(env) {            
            ...
            {
                // 4) full info missing, is old or re-connected to a different env
