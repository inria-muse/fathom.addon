...
/** Baselines are run at randomized interval: BASELINE_INTERVALS[0] +/- BASELINE_RAND seconds. */
exports.BASELINE_RAND = 30;
...
exports.BASELINE_TR_FREQ = 10; // every x rounds (e.g. 10 -> every 1200s ~ 20min)
...
/** User activity treshold (in seconds). */
exports.BASELINE_ENV_ACTIVITY_TTL = 5;

/** Env max TTL (to refresh external info) (in seconds). */
exports.BASELINE_ENV_MAX_TTL = 24*3600;

/** Propability to run ping measurement towards a whitelisted domain. */
exports.PAGELOAD_PING = 0.33;

/** Conditional propability to run traceroute measurement towards a whitelisted domain (if ping was run). */
exports.PAGELOAD_TR = 0.5;
...
exports.UPLOAD_INTERVAL = 20*60; // 20min
...
/** Alexa top ~50 domains + content delivery networks, whitelisted by default for page load monitoring. */
exports.ALEXA_TOP = [
    ...
    'akamaihd.net', // Akamai CDN (used by FB etc.)
    'licnd.com',    // LinkedIN CDN
    'dmcdn.net'     // Dailymotion CDN
];